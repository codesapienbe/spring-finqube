...
/**
 * Result of a validation health check.
 *
 * <p>This class encapsulates the result of performing a health check on a validator,
 ...
 * @since 0.1.0
 */
public class ValidationHealthCheck {
    ...
    /**
     * Constructs a new ValidationHealthCheck.
     *
     ...
     */
    public ValidationHealthCheck(String validatorId, HealthStatus status, String message,
    ...
    /**
     * Checks if the validator is healthy.
     *
    ...
    /**
     * Checks if the validator is degraded.
     *
    ...
    /**
     * Checks if the validator is unhealthy.
     *
    ...
    public enum HealthStatus {
        HEALTHY("Healthy", "Validator is functioning normally"),
        DEGRADED("Degraded", "Validator is functioning but with reduced performance"),
        UNHEALTHY("Unhealthy", "Validator is not functioning properly");
